...
let g:Powerline#Colorschemes#zenburn#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['mode_indicator'], {
		\ 'n': ['darkestcyan', 'zen_color_1', ['bold']],
		\ 'i': ['zen_color_2', 'zen_color_3', ['bold']],
		\ 'v': ['zen_color_4', 'zen_color_5', ['bold']],
		\ 'r': ['white', 'zen_color_4', ['bold']],
		\ 's': ['white', 'gray5', ['bold']],
		\ }),
	\
	...
	\ Pl#Hi#Segments(['fileinfo', 'filename'], {
		\ 'n': ['zen_color_3', 'gray4', ['bold']],
		\ 'N': ['gray7', 'gray1', ['bold']],
		\ 'i': ['zen_color_3', 'gray4', ['bold']],
		\ }),
	\
